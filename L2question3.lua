...
function scene:create( event )
    ...
    wrongText1 = display.newText("Yes it does", display.contentWidth*5/7, display.contentHeight*5.5/7, Arial, 75)
    wrongText2 = display.newText("It has oranges", display.contentCenterX, display.contentHeight*5/8, Arial, 75)
    -----------------------------------------------------------------------------------------
