...
function scene:create( event )
    ...
    wrongText1 = display.newText("Butter", display.contentWidth*3.5/7, display.contentHeight*5.5/7, Arial, 70)
    wrongText2 = display.newText("Pepper", display.contentWidth*3.5/7, display.contentHeight*3.5/7, Arial, 75)
    -----------------------------------------------------------------------------------------
